...
try:
    ...
    print('1 - images_list')
    print(*images_list)
    print('1.1 - images_list')
    print(images_list)
    print('1.2 - images_list')
    print(images_list['segment_with'])
    print('1.3 - images_list')
    print(images_list['relative_path'])
    print('2 - file_ending')
    print(file_ending)
    print('3 - background_remove_path')
    print(background_remove_path)
    print('4 - len(images_list)')
    print(len(images_list))
    segmentation_image_list = segmentation.parameters.segmentation_list(images_list, file_ending,
                                                                        background_remove_path)
    print(segmentation_image_list)
    # Run in parallel
    ray.shutdown()
    ray.init(num_cpus=use_x_cpus)
    result_ids = []
