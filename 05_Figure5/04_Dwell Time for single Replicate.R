...
Plot +
  ...
  annotate(
    ...
    y = 100,
    label = paste0(
      "DMSO Mean +/- SEM = ", signif(Cell_Summary_by_Cohort$DWELL_TIME_MEAN[1], digits = 4), " +/- ", signif(Cell_Summary_by_Cohort$SEM[1], digits = 4), "\n",
      "PF06650883_20uM Mean +/- SEM = ", signif(Cell_Summary_by_Cohort$DWELL_TIME_MEAN[2], digits = 4), " +/- ", signif(Cell_Summary_by_Cohort$SEM[2], digits = 4), "\n",
      "PF06650883_500nM Mean +/- SEM = ", signif(Cell_Summary_by_Cohort$DWELL_TIME_MEAN[3], digits = 4), " +/- ", signif(Cell_Summary_by_Cohort$SEM[3], digits = 4)
    ),
    color="black",
    size=3
  ) +
