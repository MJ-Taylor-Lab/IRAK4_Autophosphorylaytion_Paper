...
Plot_Script_Directory <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/IRAK4_Autophosphorylaytion_Paper/02_Figure_Scripts/05_Figure5/Figure5D_5E"
...
# Creating Folder to save Images
Plot_Directory_Path <- file.path(Plot_Directory_Path, "Figure_5D_5E")
if(!file.exists(Plot_Directory_Path)){
  dir.create(Plot_Directory_Path)
}
