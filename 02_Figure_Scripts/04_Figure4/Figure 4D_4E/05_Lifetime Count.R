...
Table <- fread("/Volumes/TAYLOR-LAB/Niranjan/Image_Analysis_Grid/IRAK1KinaseDomainOnly/TrackMate_Information.csv")
...
# Create directories to save the plot if they don't already exist
Plot_Directory_Save_Path <- file.path(Plot_Directory_Save_Path, "04_Figure4E")
if (!file.exists(Plot_Directory_Save_Path)) {
  dir.create(Plot_Directory_Save_Path)
}
