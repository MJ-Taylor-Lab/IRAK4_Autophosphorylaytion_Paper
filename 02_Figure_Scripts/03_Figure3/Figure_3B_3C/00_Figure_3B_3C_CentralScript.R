...
# Loading data
Table1 <- fread("/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/14_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4WT-GFP+mIRAK1WT-mScarlet_Analysis.csv.gz")
Table2 <- fread("/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/15_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4K213-214A-GFP+mIRAK1WT-mScarlet_Analysis.csv.gz")

# Setting directory paths
Plot_Directory_Save_Path <- "/Users/u_niranjan/Desktop/Cell_Figures/Plots"
Plot_Script_Directory <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/IRAK4_Autophosphorylaytion_Paper/02_Figure_Scripts/03_Figure3/Figure_3B_3C"
...
Table <- Table %>% 
  mutate(
    ORDER_NUMBER = case_when(
      ...
      SHORT_LABEL == "IRAK4 K213-214A + IRAK1 WT" ~ 2
    ),
    SHORT_LABEL = case_when(
      SHORT_LABEL == "IRAK4 WT + IRAK1 WT" ~ "IRAK4-WT",
      SHORT_LABEL == "IRAK4 K213-214A + IRAK1 WT" ~ "IRAK4-KA"
    ),
...
# Creating Folder to save Images
Plot_Directory_Path <- file.path(Plot_Directory_Path, "Figure_3B_3C")
if(!file.exists(Plot_Directory_Path)){
  dir.create(Plot_Directory_Path)
}
...
UPPER_LIMIT = 61 # The Plot a-axis Upper limit
