...
# Loading data
Table1 <- fread("/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/06_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4WT-GFP+mIRAK2WT-mScarlet_Analysis.csv.gz")
Table2 <- fread("/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/07_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4DD-GFP+mIRAK2WT-mScarlet_Analysis.csv.gz")

# Setting directory paths
Plot_Directory_Save_Path <- "/Users/u_niranjan/Desktop/Cell_Figures/Plots"
Plot_Script_Directory <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/IRAK4_Autophosphorylaytion_Paper/02_Figure_Scripts/02_Figure2/Figure_2D_2E"
Plot_Script_Directory_Supplementary <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/IRAK4_Autophosphorylaytion_Paper/02_Figure_Scripts/02_SupplementaryFigure2/SupplementaryFigure_2D"
...
Table <- Table %>% 
  mutate(
    SHORT_LABEL = case_when(
      ...
      SHORT_LABEL == "IRAK4 DD + IRAK2 WT" ~ "IRAK4-DD"
    ),
...
# Creating Folder to save Images
Plot_Directory_Path <- file.path(Plot_Directory_Path, "Figure_2D_2E")
if(!file.exists(Plot_Directory_Path)){
  dir.create(Plot_Directory_Path)
}
...
# Creating Folder to save Images
Plot_Directory_Path <- file.path(Plot_Directory_Path, "Supplementary_Figure_2D")
if(!file.exists(Plot_Directory_Path)){
  dir.create(Plot_Directory_Path)
}
