...
Y_AXIS_LABEL = "# of IRAK3 (per cell)"  # Y-axis label for the plots
YAXIS_LOWER_LIMIT_LESS_THAN_PLOT = 0  # Lower y-axis limit for "<4" size category
YAXIS_UPPER_LIMIT_LESS_THAN_PLOT = 1000  # Upper y-axis limit for "<4"
YAXIS_LOWER_LIMIT_GREATER_THAN_PLOT = 0  # Lower y-axis limit for ">=4"
YAXIS_UPPER_LIMIT_GREATER__THAN_PLOT = 80  # Upper y-axis limit for ">=4"



# DATA PROCESSING-----------------------------------------------
# Finding number of IRAK3 spots per cell that are greater or less than size of Threshold of 4
IRAK3_Size_Summary <- Table %>% 
...
IRAK3_Size_Summary_ByImage <- IRAK3_Size_Summary %>% 
  group_by(
    IMAGE,
    SIZE_CATEGORY,
    SHORT_LABEL
  ...
  mutate(
    COLOR = case_when(
      ...
      SHORT_LABEL == "IRAK4-DD" ~ "#F99108"
    ),
    COHORT = paste0(SHORT_LABEL, "_", SIZE_CATEGORY)
  ) 

# Summary statistics by cohort
IRAK3_Size_Summary_ByCohort <- IRAK3_Size_Summary_ByImage %>% 
  arrange(
    SHORT_LABEL,
    IMAGE
  ) %>% 
...
IRAK3_Size_Summary_LessThan <- IRAK3_Size_Summary %>% 
  filter(
    SIZE_CATEGORY == "<4"
  )

IRAK3_Size_Summary_LessThan$SHORT_LABEL <- 
  factor(
    IRAK3_Size_Summary_LessThan$SHORT_LABEL,
    levels = c("IRAK4-WT", "IRAK4-DD")
  )

IRAK3_Size_Summary_ByCohort_LessThan <- IRAK3_Size_Summary_ByCohort %>% 
  filter(
    SIZE_CATEGORY == "<4"
  )

IRAK3_Size_Summary_ByCohort_LessThan$SHORT_LABEL <- 
  factor(
    IRAK3_Size_Summary_ByCohort_LessThan$SHORT_LABEL,
    levels = c("IRAK4-WT", "IRAK4-DD")
  )

IRAK3_Size_Summary_ByImage_LessThan <- IRAK3_Size_Summary_ByImage %>% 
  filter(
    SIZE_CATEGORY == "<4"
  )
...
if(p_value_test_confirmation == "Y"){
  ...
  Combination_Table <- unique(IRAK3_Size_Summary_ByImage_LessThan$COHORT)
  ...
  Combination_Function <- function(index){
    ...
    p_value_Result <- IRAK3_Size_Summary_ByImage_LessThan %>% 
      rowwise() %>% 
      mutate(
...
IRAK3_Size_Summary_GreaterThan <- IRAK3_Size_Summary %>% 
  filter(
    SIZE_CATEGORY != "<4"
  )

IRAK3_Size_Summary_GreaterThan$SHORT_LABEL <- 
  factor(
    IRAK3_Size_Summary_GreaterThan$SHORT_LABEL,
    levels = c("IRAK4-WT", "IRAK4-DD")
  )
...
IRAK3_Size_Summary_ByCohort_GreaterThan <- IRAK3_Size_Summary_ByCohort %>% 
  filter(
    SIZE_CATEGORY != "<4"
  )

IRAK3_Size_Summary_ByImage_GreaterThan <- IRAK3_Size_Summary_ByImage %>% 
  filter(
    SIZE_CATEGORY != "<4"
  ) %>% 
  arrange(
...
if(p_value_test_confirmation == "Y"){
  # Original list with 2-5 components
  Combination_Table <- unique(IRAK3_Size_Summary_ByImage_GreaterThan$COHORT)
  ...
  Combination_Function <- function(index){
    ...
    p_value_Result <- IRAK3_Size_Summary_ByImage_GreaterThan %>% 
      rowwise() %>% 
      mutate(
        TEST = COHORT %in% Combination$SHORT_LABEL
      ) %>% 
...
rm(
  IRAK3_Size_Summary,
  IRAK3_Size_Summary_ByCohort,
  IRAK3_Size_Summary_ByImage,
  p_value_Table
)
...
#   data = IRAK3_Size_Summary_ByCohort_LessThan
# ) +
#   geom_quasirandom(
#     data = IRAK3_Size_Summary_LessThan,
#     aes(
#       x = SHORT_LABEL,
#       y = NUMBER_OF_TRACKS,
#     ),
...
#   # Add Image Means
#   geom_jitter(
#     data = IRAK3_Size_Summary_ByImage_LessThan,
#     aes(
#       y = MEAN_NUMBER_OF_TRACKS,
#       x = SHORT_LABEL
#     ),
#     shape = 21,
#     fill = IRAK3_Size_Summary_ByImage_LessThan$COLOR,
#     size = 1.2,
#     stroke = 0.2,
...
#   data = IRAK3_Size_Summary_ByCohort_GreaterThan
# ) +
#   geom_quasirandom(
#     data = IRAK3_Size_Summary_GreaterThan,
#     aes(
#       x = SHORT_LABEL,
#       y = NUMBER_OF_TRACKS,
#     ),
...
#   # Add Image Means
#   geom_jitter(
#     data = IRAK3_Size_Summary_ByImage_GreaterThan,
#     aes(
#       y = MEAN_NUMBER_OF_TRACKS,
#       x = SHORT_LABEL
#     ),
#     shape = 21,
#     fill = IRAK3_Size_Summary_ByImage_GreaterThan$COLOR,
#     size = 1.2,
#     stroke = 0.2,
#     width = 0.1  # Control vertical spread
#   ) +
...
write_xlsx(
  list(
    ...
    "IRAK3_Size_Summary_LessThan" = IRAK3_Size_Summary_LessThan,
    "IRAK3_Size_Summary_ByImage_LessThan" = IRAK3_Size_Summary_ByImage_LessThan,
    "IRAK3_Size_Summary_ByCohort_LessThan" = IRAK3_Size_Summary_ByCohort_LessThan,
    "IRAK3_Size_Summary_GreaterThan" = IRAK3_Size_Summary_GreaterThan,
    "IRAK3_Size_Summary_ByImage_GreaterThan" = IRAK3_Size_Summary_ByImage_GreaterThan,
    "IRAK3_Size_Summary_ByCohort_GreaterThan" = IRAK3_Size_Summary_ByCohort_GreaterThan
  ),
...
write.csv(IRAK3_Size_Summary_ByImage_GreaterThan, Plot_Save_Path)
...
# Cleanup --------------------------------------------------------
rm(
  IRAK3_Size_Summary_LessThan,
  IRAK3_Size_Summary_ByImage_LessThan,
  IRAK3_Size_Summary_ByCohort_LessThan,
  IRAK3_Size_Summary_GreaterThan,
  IRAK3_Size_Summary_ByImage_GreaterThan,
  IRAK3_Size_Summary_ByCohort_GreaterThan,
