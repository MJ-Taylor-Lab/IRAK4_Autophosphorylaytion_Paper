...
# Loading data
Table1 <- fread("/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/08_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4WT-GFP+mIRAK3WT-mScarlet_Analysis.csv.gz")
Table2 <- fread("/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/09_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4DD-GFP+mIRAK3WT-mScarlet_Analysis.csv.gz")

# Setting directory paths
Plot_Directory_Save_Path <- "/Users/u_niranjan/Desktop/Cell_Figures/Plots"
Plot_Script_Directory <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/IRAK4_Autophosphorylaytion_Paper/02_Figure_Scripts/02_Figure2/Figure_2G_2H"
Plot_Script_Directory_Supplementary <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/IRAK4_Autophosphorylaytion_Paper/02_Figure_Scripts/02_SupplementaryFigure2/SupplementaryFigure_2E"
...
Table <- Table %>% 
  mutate(
    SHORT_LABEL = case_when(
      SHORT_LABEL == "IRAK4 WT + IRAK3 WT" ~ "IRAK4-WT",
      SHORT_LABEL == "IRAK4 DD + IRAK3 WT" ~ "IRAK4-DD"
    ),
...
# Creating Folder to save Images
Plot_Directory_Path <- file.path(Plot_Directory_Path, "Figure_2G_2H")
if(!file.exists(Plot_Directory_Path)){
  dir.create(Plot_Directory_Path)
}
...
UPPER_LIMIT = 40 # The Plot a-axis Upper limit
...
# Creating Folder to save Images
Plot_Directory_Path <- file.path(Plot_Directory_Path, "Supplementary_Figure_2E")
if(!file.exists(Plot_Directory_Path)){
  dir.create(Plot_Directory_Path)
}
