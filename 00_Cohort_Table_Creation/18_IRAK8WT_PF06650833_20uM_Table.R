...
Table1 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20221022/18_IRAK3WT_PF06650833_20uM/20231010/Output/Analysis.csv.gz")
Table2 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20221022/18_IRAK3WT_PF06650833_20uM/20231013/Output/Analysis.csv.gz")
Table3 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20221022/18_IRAK3WT_PF06650833_20uM/20231019/Output/Analysis.csv.gz")
...
Table <- Table %>% 
  filter(
    COHORT == "IRAK3WT+PF06650833_20uM"
  ) %>% 
  mutate(
...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/00_Myddosomal_internal_phosphorylation_cohort_table/18_IRAK3WT_PF06650833_20uM_Compiled_Essential.csv.gz"
