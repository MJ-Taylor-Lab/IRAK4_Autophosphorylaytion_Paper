...
Table1 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20221022/15_IRAK2WT_PF06650833_500nM/20230827/Output/Analysis.csv.gz")
Table2 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20221022/15_IRAK2WT_PF06650833_500nM/20230831/Output/Analysis.csv.gz")
Table3 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20221022/15_IRAK2WT_PF06650833_500nM/20230905/Output/Analysis.csv.gz")
...
Table <- Table %>% 
  filter(
    COHORT == "IRAK2WT+PF06650833_500nM"
  ) %>% 
  mutate(
...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/00_Myddosomal_internal_phosphorylation_cohort_table/15_IRAK2WT_PF06650833_500nM_Compiled_Essential.csv.gz"
