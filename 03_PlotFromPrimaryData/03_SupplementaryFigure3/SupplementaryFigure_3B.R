...
Cell_Summary_by_Image <- read_excel(Primary_Data, sheet = "Supplementary Figure 3B")
...
# Creating Folder to save Images
Plot_Directory_Save_Path <- file.path(Plot_Directory_Save_Path, "Supplementary Figure_3B")
if(!file.exists(Plot_Directory_Save_Path)){
  dir.create(Plot_Directory_Save_Path)
}
