...
Colocalisation_Percentage_byCell <- read_excel(Primary_Data, sheet = "Supplementary Figure 3C")
...
# Creating Folder to save Images
Plot_Directory_Save_Path <- file.path(Plot_Directory_Save_Path, "Supplementary Figure_3C")
if(!file.exists(Plot_Directory_Save_Path)){
  dir.create(Plot_Directory_Save_Path)
}
