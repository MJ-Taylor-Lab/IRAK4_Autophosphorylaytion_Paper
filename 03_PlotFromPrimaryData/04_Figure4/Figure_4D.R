...
UPPER_LIMIT = 1300 # The Plot a-axis Upper limit
LOWER_LIMIT_AXIS_TICKS = 0 # Axis Lower Limit
X_AXIS_INTERVAL = 600 # Axis tick mark Interval 

# Opening Data for relevant plot ----------------------------------------
Cell_Summary_by_Cell <- read_excel(Primary_Data, sheet = "Figure 4D")
...
# Creating Folder to save Images
Plot_Directory_Save_Path <- file.path(Plot_Directory_Save_Path, "Figure_4D")
if(!file.exists(Plot_Directory_Save_Path)){
  dir.create(Plot_Directory_Save_Path)
}
