...
Cell_Summary_by_Cell <- read_excel(Primary_Data, sheet = "Supplementary Figure 4A")
...
# Creating Folder to save Images
Plot_Directory_Save_Path <- file.path(Plot_Directory_Save_Path, "Supplementary Figure 4A")
if(!file.exists(Plot_Directory_Save_Path)){
  dir.create(Plot_Directory_Save_Path)
}
