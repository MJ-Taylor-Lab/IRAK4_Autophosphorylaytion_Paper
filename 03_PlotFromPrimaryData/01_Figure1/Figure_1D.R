...
Colocalisation_Percentage_byCell <- read_excel(Primary_Data, sheet = "Figure 1D")
...
# Creating Folder to save Images
Plot_Directory_Save_Path <- file.path(Plot_Directory_Save_Path, "Figure_1D")
if(!file.exists(Plot_Directory_Save_Path)){
  dir.create(Plot_Directory_Save_Path)
}
