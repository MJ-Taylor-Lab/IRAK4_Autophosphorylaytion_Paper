...
Table1 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20230727_IRAK4PhosphoPaper/10_IRAK1KI_PF06650833_500nM/20230414/Output/Analysis.csv.gz")
Table2 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/Analysis Output/20230727_IRAK4PhosphoPaper/10_IRAK1KI_PF06650833_500nM/20230608/Output/Analysis.csv.gz")
...
Table <- Table %>% 
  filter(
    COHORT == "IRAK1KI+PF06650833_500nM"
  ) %>% 
  mutate(
...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/00_Myddosomal_internal_phosphorylation_cohort_table/10_IRAK1KI_PF06650833_500nM_Compiled_Essential.csv.gz"
