...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/11_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4WT-GFP+mIRAK2DD-mScarlet_Analysis.csv.gz"
