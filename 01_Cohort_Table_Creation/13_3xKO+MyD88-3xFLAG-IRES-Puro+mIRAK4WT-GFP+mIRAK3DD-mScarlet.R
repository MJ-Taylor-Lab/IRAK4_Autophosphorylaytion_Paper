...
Table2 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/raven/Analysis_Output/IRAK4_Kinase_Paper_InProgress/42_TKO+MyD88-3xFLAG-IRES-Puro_mIRAK4WT_mIRAK3DD/20250304_2time/20250304/Output/Analysis.csv.gz")
Table3 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/raven/Analysis_Output/IRAK4_Kinase_Paper_InProgress/42_TKO+MyD88-3xFLAG-IRES-Puro_mIRAK4WT_mIRAK3DD/20250311/Output/Analysis.csv.gz")
Table4 <- fread("/Volumes/TAYLOR-LAB/Niranjan/04 Image Analysis/raven/Analysis_Output/IRAK4_Kinase_Paper_InProgress/42_TKO+MyD88-3xFLAG-IRES-Puro_mIRAK4WT_mIRAK3DD/20250318/Output/Analysis.csv.gz")
...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/13_3xKO+MyD88-3xFLAG-IRES-Puro+mIRAK4WT-GFP+mIRAK3DD-mScarlet_Analysis.csv.gz"
