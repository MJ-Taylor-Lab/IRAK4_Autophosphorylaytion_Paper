...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/42_MyD88-GFP+IRAK4-KO+IRAK4R12C-mScarlet_Analysis.csv.gz"
