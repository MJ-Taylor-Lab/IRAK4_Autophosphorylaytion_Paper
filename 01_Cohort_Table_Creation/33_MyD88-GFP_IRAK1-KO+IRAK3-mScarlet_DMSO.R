...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/33_MyD88-GFP_IRAK1-KO+IRAK3-mScarlet_DMSO_Analysis.csv.gz"
