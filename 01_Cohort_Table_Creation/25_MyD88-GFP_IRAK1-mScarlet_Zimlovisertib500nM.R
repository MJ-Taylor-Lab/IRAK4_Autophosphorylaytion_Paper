...
Table_path <- "/Users/u_niranjan/Desktop/Git Scripts/01_IRAK4 Phosphorylation Paper/00_Cohort_table/25_MyD88-GFP_IRAK1-mScarlet_Zimlovisertib500nM_Analysis.csv.gz"
