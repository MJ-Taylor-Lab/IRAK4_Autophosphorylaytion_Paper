...
Cell_Summary_by_Track<-
  ...
  mutate(
    COLOCALIZATION = COMPLEMENTARY_NORMALIZED_INTENSITY_1 >= 2.5 #1.5 #threshold at which recruitment is counted
  ) %>% 
  group_by(
    UNIVERSAL_TRACK_ID
  ) %>%
...
Colocalisation_Fx <- function(Count){
  ...
  df_p_val_IRAK4WTIRAK1WTvsIRAK4KDIRAK1WT <- data.frame(
  ...
  df_p_val_IRAK4WTIRAK1WTvsIRAK4DDIRAK1WT <- data.frame(
    group1 = "IRAK4 WT + IRAK1 WT",
  ...
  df_p_val_IRAK4KDIRAK1WTvsIRAK4DDIRAK1WT <- data.frame(
  ...
  Plot +
    ...
    add_pvalue(
      df_p_val_IRAK4WTIRAK1WTvsIRAK4KDIRAK1WT,
      xmin = "group1",
      xmax = "group2",
      label = "p = {label}",
    ...
    add_pvalue(
      df_p_val_IRAK4WTIRAK1WTvsIRAK4DDIRAK1WT,
      xmin = "group1",
      xmax = "group2",
      label = "p = {label}",
      y.position = "y.position",
    ...
    add_pvalue(
      df_p_val_IRAK4KDIRAK1WTvsIRAK4DDIRAK1WT,
      xmin = "group1",
      xmax = "group2",
      label = "p = {label}",
      y.position = "y.position",
