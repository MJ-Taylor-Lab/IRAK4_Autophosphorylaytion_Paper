...
Cell_Summary_by_Track<-
  ...
  mutate(
    IMAGE_REMOVAL = case_when(
      IMAGE == "20231019 plate02_well8B_5nM_cl359_IRAK3WT_DMSO_001" | IMAGE == "20231019 plate01_well7B_5nM_cl359_IRAK3WT_inhi20um_001" | IMAGE == "20231019 plate02_well8C_5nM_cl359_IRAK3WT_inhi500nm_001" ~ 1,
      TRUE ~ 0
    )
  ) %>%
  mutate(
