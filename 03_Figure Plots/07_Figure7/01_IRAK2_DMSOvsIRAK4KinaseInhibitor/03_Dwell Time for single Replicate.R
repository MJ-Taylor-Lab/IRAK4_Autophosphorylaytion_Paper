...
Cell_Summary_by_Track<-
  ...
  mutate(
    IMAGE_REMOVAL = case_when(
      IMAGE == "20230827 plate01_well5C_5nM_cl356_IRAK2WT_DMSO_001" | IMAGE == "20230827 plate01_well6C_5nM_cl356_IRAK2WT_inhi500nM_001" | IMAGE == "20230827 plate02_wellB5_5nM_cl356_IRAK2WT_inhi20um_001" ~ 1,
      TRUE ~ 0
    )
  ) %>%
  mutate(
