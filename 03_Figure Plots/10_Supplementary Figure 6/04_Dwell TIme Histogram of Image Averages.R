...
UPPER_LIMIT = 61       #Axis Upper Limit
AXIS_BREAK_SEQ = 10        #X axis tick marks
...
Plot +
  ...
  annotate(
    ...
    y = 200,
    label = paste0(
      "IRAK1 WT Mean +/- SD = ", signif(Cell_Summary_by_Cohort$DWELL_TIME_MEAN[1], digits = 4), " +/- ", signif(Cell_Summary_by_Cohort$SEM[1], digits = 4), "\n",
      "IRAK2 WT Mean +/- SD = ", signif(Cell_Summary_by_Cohort$DWELL_TIME_MEAN[2], digits = 4), " +/- ", signif(Cell_Summary_by_Cohort$SEM[2], digits = 4), "\n",
      "IRAK3 WT Mean +/- SD = ", signif(Cell_Summary_by_Cohort$DWELL_TIME_MEAN[3], digits = 4), " +/- ", signif(Cell_Summary_by_Cohort$SEM[3], digits = 4)
    ),
    color="black",
    size=3
  ) +
